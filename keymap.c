...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, LGUI_T(KC_ESC), LALT_T(KC_BSPC), LCTL_T(KC_DEL), LT(_NAV, KC_ENT), KC_SPC, LT(_NUM, KC_TAB), XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_SETTINGS] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TO(_FPS), TO(_LEAGUE), RGB_TOG, RGB_SPD, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, PLOVER, XXXXXXX, RGB_RMOD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, MAGIC_SWAP_LCTL_LGUI, XXXXXXX, MAGIC_UNSWAP_LCTL_LGUI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
)
